    ...
    <section className="relative min-h-screen pt-24 flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 py-12 md:py-16 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "200ms" }}>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 animate-fade-in" style={{ animationDelay: "400ms" }}>
            <a 
      ...
      <div className="container mx-auto px-4 md:px-8 mt-8 mb-16 z-10">
        <div className="max-w-4xl mx-auto glass-card p-3 animate-fade-in" style={{ animationDelay: "600ms" }}>
          <VideoEmbed 
            videoId="lGsefWkYfq0" 
            title="Firefighter GPT Anthem" 
            autoplay={true} 
            muted={false}
          />
        </div>
