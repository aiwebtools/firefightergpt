...
const Hero: React.FC = () => {
  return <section className="relative min-h-screen pt-24 flex flex-col justify-center items-center overflow-hidden">
      {/* Hero Content */}
      <div className="container mx-auto px-4 md:px-8 py-12 md:py-16 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          animationDelay: "500ms"
            ...
            <p>For educational, research, and informational purposes only. Not intended to replace professional firefighting services or emergency response. Always contact local emergency services in case of fire.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 mt-8 mb-16 z-10">
        ...
        animationDelay: "600ms"
          ...
          <VideoEmbed videoId="lGsefWkYfq0" title="Firefighter GPT Anthem" autoplay={true} muted={false} />
        </div>
      </div>
